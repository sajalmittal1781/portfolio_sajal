...
//           <p className="mt-12" style={{ color: "#EEEEEE" }}>
...
//       <img src={about} alt="home img" className="mb-4  mr-40 " />
//     </div>
//   );
// };
...
const About = () => {
  return (
    <div id="about" className="ml-2 mr-2 h-screen flex flex-col lg:flex-row justify-between items-center">
      <div className="flex flex-col lg:flex-row items-center lg:ml-60 mb-8 lg:mb-0">
        {/* <img src={home1} className="mt-24 h-28 mr-4" alt="homeimg" /> */}
        <div className="lg:w-96">
          {/* <h1 style={{ color: "#EEEEEE" }} className="ml-2 text-4xl lg:text-7xl font-bold font-mono">
            About <span style={{ color: bluee }}>Me</span>
          </h1> */}

<h1 style={{ color: "#EEEEEE" }} className="ml-2 text-4xl lg:text-7xl font-bold font-mono text-center lg:text-left lg:mx-0">
  About <span style={{ color: bluee }}>Me</span>
</h1>
