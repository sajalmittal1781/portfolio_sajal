...
const Home = () => {
  ...
  return (
    <div
      id="home"
      className="h-screen flex flex-col lg:flex-row justify-between items-center "
    >
      <ToastContainer />
      <div className="flex flex-row lg:flex-row items-center lg:ml-60 mb-8 lg:mb-0 ">
        ...
        <div className="text-center lg:text-left">
          <h1
            style={{ color: "#EEEEEE" }}
            className="text-4xl lg:text-7xl font-bold font-mono"
          >
            Creative Web
          </h1>
          <h1
      ...
      <img
        src={home2}
        alt="home img"
        className="ml-8 mb-4 lg:mb-0 mr-4 lg:mr-40"
      />
    </div>
  );
};
